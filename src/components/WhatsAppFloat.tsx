    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <div className="relative">
        ...
        >
          ...
          {/* Pulse animation */}
          <span className="absolute top-0 left-0 w-full h-full bg-green-400 rounded-full animate-ping opacity-75"></span>
        </button>
      ...
      <button
        ...
        className="absolute -top-2 -left-2 bg-gray-600 hover:bg-gray-700 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs md:hidden"
